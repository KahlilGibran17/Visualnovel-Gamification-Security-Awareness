        ...
        <Layout>
            <div className="p-6 max-w-6xl mx-auto space-y-6">
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <p className="text-muted mt-1">Manage chapters, dialogue scenes, and quiz choices</p>
                </motion.div>
                        ...
                        {loading ? (
                            ...
                            return (
                                <motion.div key={ch.id}
                                    ...
                                    <span className={`text-xs px-3 py-1 rounded-full font-semibold ${ch.status === 'Published' ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-input-bg text-muted border border-card-border'
                                        }`}>
                                        {ch.status}
                                    </span>
                ...
                {selected && (
                    <motion.div className="glass-card p-6"
                        ...
                        <div className="bg-card-bg rounded-xl p-4 mb-4 border border-card-border">
                            <p className="text-muted text-sm mb-3">Raw JSON Configuration (Scenes & Choices Array)</p>
                            <textarea
