...
function ChapterCard({ chapter, chapterIndex, onLessonClick, isLocked, pretestStatus, onPretestClick, isNoXpRole, defaultOpen }) {
                        ...
                        {chapterList.map((chapter, i) => {
                            ...
                            return (
                                <ChapterCard
                                    ...
                                    isNoXpRole={isNoXpRole}
                                    defaultOpen={targetChapterId ? chapter.id.toString() === targetChapterId.toString() : false}
                                />
                            )
                        })}
                    </div>
